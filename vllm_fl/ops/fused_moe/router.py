    ...
    def _compute_routing(
        ...
        *,
        ...
        if (
            ...
            # One group selects across all experts. Bias affects selection;
            # returned weights use the unbiased sigmoid scores.
            topk_weights, topk_ids = _grouped_topk(
                router_logits, 1, 1, self.top_k, self.renormalize,
                1.0, self.e_score_correction_bias.data, 1,
            )
