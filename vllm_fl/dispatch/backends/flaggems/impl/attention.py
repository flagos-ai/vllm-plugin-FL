...
class AttentionFLBackend(AttentionBackend):
    ...
    # vLLM v1 splits KV-cache write from attention forward: do_kv_cache_update()
    # writes the cache via reshape_and_cache_flash, then forward() reads from it
    # via flash_attn_varlen_func. Signal this to vLLM so it calls the write step.
