...
class ModelRunnerFL(
    ...
    def _allocate_kv_cache_tensors(
        ...
        for kv_cache_tensor in kv_cache_config.kv_cache_tensors:
            if is_npu_hybrid:
                # Split into attention and mamba tensors: NPU attention
                # kernels' contiguous layout overlaps mamba's strided
                # page-aligned layout when sharing the same underlying buffer.
                # Also bypass the packed-backing path (below): NPU requires
                # independent tensors per layer group.
                mamba_layers = [
                    n for n in kv_cache_tensor.shared_by
