.196, 0.184, 0.172, 0.159, 0.149, 0.137, 0.124, 0.112, 0.1, 0.086, 0.074, 0.062, 0.05, 0.035, 0.023, 0.009, -0.003, -0.015, -0.027, -0.039, -0.052, -0.063, -0.074, -0.085, -0.097, -0.109, -0.122, -0.134, -0.147, -0.158, -0.171, -0.184, -0.196, -0.21, -0.223, -0.235, -0.248, -0.261, -0.275, -0.289, -0.302, -0.317, -0.328, -0.341, -0.353, -0.368, -0.382, -0.396, -0.41, -0.426, -0.439, -0.452, -0.465, -0.48, -0.493, -0.507, -0.521, -0.537, -0.551, -0.568, -0.582, -0.597, -0.614, -0.628, -0.643, -0.658, -0.673, -0.691, -0.706, -0.721, -0.738, -0.754, -0.769, -0.789, -0.808, -0.824, -0.838, -0.857, -0.877, -0.893, -0.912, -0.929, -0.947, -0.965, -0.983, -1.003, -1.027, -1.05, -1.07, -1.092, -1.117, -1.139, -1.162, -1.189, -1.216, -1.241, -1.272, -1.3, -1.33, -1.367, -1.404, -1.441, -1.485, -1.523, -1.564, -1.607, -1.658, -1.71, -1.778, -1.832, -1.901, -1.978, -2.068, -2.174, -2.325, -2.577, -3.813]
...
def _update_min_larger_stats(data, above_mask, min_larger, num_min_larger, sentinel):
    ...
    tile_eq = above_mask & (tl.abs(data - tile_min) < 1e-09)
    tile_cnt = tl.sum(tile_eq)
    is_new = tile_min < min_larger
    is_same = tl.abs(tile_min - min_larger) < 1e-09
...
@triton.jit
def _topk_topp_kernel(LOGITS, LOGITS_STRIDE_0, BUFFER, PERCENTILE_TO_STD_TABLE, NORMAL_CDF_TO_SIGMA_TABLE, K, P, BATCH_SIZE, VOCAB_SIZE: tl.constexpr, MASK_VALUE: tl.constexpr, BLOCK_SIZE: tl.constexpr, BLOCK_SIZE_TRUNC: tl.constexpr, TOPK_ENABLED: tl.constexpr, TOPP_ENABLED: tl.constexpr):
    ...
    for row_id in tl.range(pid, BATCH_SIZE, num_programs):
        ...
        if TOPK_ENABLED:
            ...
            if k < VOCAB_SIZE:
                ...
                sq_avg_logit = tl.where(num_finite > 0, tl.sum(finite_logits * finite_logits) / num_finite, 0.0)
                ...
                if num_outliers > k:
                    ...
                    search_iters = tl.cast((num_outliers + BLOCK_SIZE_TRUNC - 1) // BLOCK_SIZE_TRUNC, tl.int32)
                    found_pivot = 0
                    while found_pivot == 0:
                        ...
                        for i in range(0, search_iters):
                            ...
                            min_larger_0, num_min_larger_0 = _update_min_larger_stats(logits_blk2, above_0, min_larger_0, num_min_larger_0, float('inf'))
                            min_larger_1, num_min_larger_1 = _update_min_larger_stats(logits_blk2, above_1, min_larger_1, num_min_larger_1, float('inf'))
                        if k_pivots_num_0 >= k:
                            if k_pivots_num_0 - num_min_larger_0 < k:
                                k_pivot = k_pivot_0
                                ...
                                found_pivot = 1
                        if k_pivots_num_1 >= k:
                            if k_pivots_num_1 - num_min_larger_1 < k:
                                k_pivot = k_pivot_1
                        ...
                        if k_pivots_num_0 < k:
                            ...
                            max_range = k_pivot_1
                        num_iters += 1
                        if num_iters >= 18 or tl.abs(min_range - max_range) < 1e-09:
                        ...
                        if p < 1.0:
                            ...
                            if num_outliers > k:
                                for i in range(0, search_iters):
                                    offs_n = i * BLOCK_SIZE_TRUNC + tl.arange(0, BLOCK_SIZE_TRUNC)
                                    mask_n_2 = offs_n < search_range
                                    probs_blk = tl.load(BUFFER_ROW + offs_n, mask=mask_n_2, other=-float('inf'))
                                    outlier_mask = (probs_blk > min_logit) & mask_n_2
                                    if num_keep < num_duplicate_logit:
                                        duplicate_mask = tl.abs(probs_blk - duplicate_logit) < 1e-09
                                ...
                                for i in range(0, NUM_TILES):
                                    ...
                                    probs_blk = tl.exp(probs_blk)
                                    sum_exp_logits += tl.sum(probs_blk)
                                    cumulative_pos = tl.cast(tl.cumsum(outlier_mask) - 1 + num_outliers_2, tl.int32)
                                ...
                                search_iters = tl.cast((num_outliers_2 + BLOCK_SIZE_TRUNC - 1) // BLOCK_SIZE_TRUNC, tl.int32)
                                for i in range(0, search_iters):
                                    offs_n = i * BLOCK_SIZE_TRUNC + tl.arange(0, BLOCK_SIZE_TRUNC)
                                    mask_n_2 = offs_n < search_range
                            ...
                            while found_pivot == 0:
                                ...
                                for i in range(0, search_iters):
                                    ...
                                    min_larger_0, num_min_larger_0 = _update_min_larger_stats(probs_blk, above_0, min_larger_0, num_min_larger_0, 1.0)
                                if p_pivots_sum_0 >= p:
                                ...
                                if p_pivots_sum_0 > p:
                                    ...
                                    max_range = p_pivot_0
                                num_iters += 1
                                if max_range - min_range < 1e-09 or num_iters >= 18:
        ...
        if not final_pivot < max_logit:
            ...
            for i in range(0, NUM_TILES):
                ...
                if num_keep < num_duplicate_logit:
                    duplicate_mask = (tl.abs(logits_blk - duplicate_logit) < 1e-09) & mask_n
                    duplicate_count = tl.cumsum(duplicate_mask) + num_kept
                    duplicate_keep_mask = (duplicate_count <= num_keep) & duplicate_mask
                    duplicate_remove_mask = duplicate_mask & ~duplicate_keep_mask
                    num_kept += tl.sum(duplicate_keep_mask)
...
def apply_top_k_top_p_triton(logits: torch.Tensor, k: torch.Tensor | None, p: torch.Tensor | None, mask_value: float=float('-inf')) -> torch.Tensor:
    """
    ...
    if tables is None:
        with gpu_sync_allowed():
            ...
            _TRITON_TABLE_CACHE[logits.device] = (normal_cdf_to_sigma_table, percentile_to_std_table)
    else:
    ...
    _topk_topp_kernel[NUM_PROGRAMS,](logits, logits.stride(0), buffer, percentile_to_std_table, normal_cdf_to_sigma_table, k_ptr, p_ptr, BATCH_SIZE=batch_size, MASK_VALUE=mask_value, VOCAB_SIZE=vocab_size, BLOCK_SIZE=block_size, BLOCK_SIZE_TRUNC=block_size_trunc, TOPK_ENABLED=topk_enabled, TOPP_ENABLED=topp_enabled, **launch_kwargs)
    return logits
