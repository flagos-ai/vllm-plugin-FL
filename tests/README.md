...
| `serve.chat_cases` | list | No | Named chat requests run against one server; `expected_keywords` validates required keyword groups and `generated_image: true` creates the local image fixture |
