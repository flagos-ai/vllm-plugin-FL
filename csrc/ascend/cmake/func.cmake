...
function(op_add_subdirectory OP_LIST OP_DIR_LIST)
    ...
    foreach(OP_CMAKE_FILE ${OP_HOST_CMAKE_FILES})
        ...
        if (DEFINED ASCEND950_SKIP_OPS AND ${OP_NAME} IN_LIST ASCEND950_SKIP_OPS)
            message(STATUS "Skipping ${OP_NAME} in op_add_subdirectory because ASCEND950 is not available.")
            continue()
        endif ()
